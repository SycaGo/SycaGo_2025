...
drive_general(120, -350, -90, True)
left_arm_motor.run_angle(3000, 500, Stop.BRAKE, True)
turn_general(70)
drive_general(70, 300, 70, True)
#drop the shark
left_arm_motor.run_angle(10000, -800, Stop.BRAKE, True)
drive_general(20, -350, 70, True)
left_arm_motor.run_angle(10000, -100, Stop.BRAKE, True)
wait(300)
drive_general(40, -350, 70, True)
left_arm_motor.run_angle(10000, 800, Stop.BRAKE, True)
